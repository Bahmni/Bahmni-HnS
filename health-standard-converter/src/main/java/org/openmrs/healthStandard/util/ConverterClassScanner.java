 ...
 */
package org.openmrs.healthStandard.util;
 ...
 */
public class ConverterClassScanner {
	
	protected final Log log = LogFactory.getLog(getClass());
	
	private static final ConverterClassScanner instance = new ConverterClassScanner();
	
	private final MetadataReaderFactory metadataReaderFactory;
	
	private final ResourcePatternResolver resourceResolver;
	
	ConverterClassScanner() {
	...
	public static ConverterClassScanner getInstance() {
